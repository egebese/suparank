...
const ClaudeIcon = () => (
  <svg className="h-5 md:h-6" viewBox="0 0 120 24" fill="currentColor">
    <text x="0" y="18" className="text-[16px] font-medium tracking-tight">Claude</text>
  </svg>
);

const CursorIcon = () => (
  <svg className="h-5 md:h-6" viewBox="0 0 120 24" fill="currentColor">
    <text x="0" y="18" className="text-[16px] font-medium tracking-tight">Cursor</text>
  </svg>
);

const ChatGPTIcon = () => (
  <svg className="h-5 md:h-6" viewBox="0 0 120 24" fill="currentColor">
    <text x="0" y="18" className="text-[16px] font-medium tracking-tight">ChatGPT</text>
  </svg>
);
